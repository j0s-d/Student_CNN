...
#--------- Modified MobileNetV2- 1,990,415 trainable parameters---------

class TeacherFaceDetector(nn.Module):
    def __init__(self, ch_in=3, fpn_channels = 128):
        ...
        #still uses 17 convolutional blocks as in v2
    ...
    def forward(self, x):
        ...
        #project predictions to 128 feature channels
