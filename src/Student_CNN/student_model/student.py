...
class FaceDetector(nn.Module):
    def __init__(self):
        ...
        self.block1 = DepthSepConv(16, 24, stride=2)

        #increases channels from 24 to 32, changes spatial resolution to 16x16
        self.block2 = DepthSepConv(24, 32, stride=2)
        ...
        self.block3 = DepthSepConv(32, 64, stride=1)

        #increases channels from 64 to 32, keeps spatial resolution at 16x16
        self.block4 = DepthSepConv(64, 128, stride=1)

        #two more convolution blocks to increase inference depth of model
        self.block5 = DepthSepConv(128, 128, stride=1)  
        self.block6 = DepthSepConv(128, 128, stride=1)  
    ...
    #passes image tensor through each block of the model in a forward pass
    #outputs predictions
    def forward(self, x):
